...
namespace Blazonia.Components.Layout
{
    ...
    /// </summary>
    public abstract partial class NonVirtualizingLayout : AttachedLayout
    {
        static NonVirtualizingLayout()
        {
            RegisterAdditionalHandlers();
        }

        public new AL.NonVirtualizingLayout NativeControl => (AL.NonVirtualizingLayout)((AvaloniaObject)this).NativeControl;
